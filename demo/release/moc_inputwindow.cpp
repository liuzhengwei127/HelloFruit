...
QT_MOC_LITERAL(3, 18, 8), // "username"
QT_MOC_LITERAL(4, 27, 9) // "post_name"

    },
    "Inputwindow\0name\0\0username\0post_name"
};
...
void Inputwindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->post_name(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Inputwindow::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Inputwindow::name)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject Inputwindow::staticMetaObject = {
    { &Window::staticMetaObject, qt_meta_stringdata_Inputwindow.data,
      qt_meta_data_Inputwindow,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 0
void Inputwindow::name(QString _t1)
{
